...
release_url=https://github.com/valyentdev/firecracker/releases/download/$(firecracker_version)/firecracker-$(firecracker_version)-$(arch).tgz
...
$(FIRECRACKER_DIR):
	- git clone https://github.com/valyentdev/firecracker.git $(FIRECRACKER_DIR)
